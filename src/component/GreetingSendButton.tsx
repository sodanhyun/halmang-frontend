...
const GreetingSendButton: React.FC<GreetingSendButtonProps> = ({ onClick }) => {
    return (
        <button
            onClick={onClick}
            className="w-full h-[62px] bg-illustration-yellow hover:bg-blue-950 active:bg-blue-950 backdrop:before:rounded-[20px] flex justify-center items-center gap-2.5 transition-colors duration-200"
        >
