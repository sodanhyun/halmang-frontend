...
const GreetingButton: React.FC<GreetingButtonProps> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="w-full h-[62px] px-[84px] py-[23px] bg-[#2a2a35] hover:bg-[#f4b756] active:bg-[#f4b756] rounded-[20px] flex justify-center items-center gap-2.5 transition-colors duration-200">
